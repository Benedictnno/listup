...
import { ArrowLeft, MapPin, Store, Package, Phone, MessageSquare } from "lucide-react";
...
export default function StorePage() {
  ...
  useEffect(() => {
    fetchStoreListings();
  }, [storeName, pagination.page]);

  const fetchStoreListings = async () => {
    try {
      setLoading(true);
      const data = await getStoreListings(storeName, pagination.page, pagination.limit);
