  ...
  useEffect(() => {
    ...
    const refreshUser = async () => {
      ...
      if (refreshCount < maxRefreshes) {
        setTimeout(refreshUser, 3000); // Poll every 3 seconds
      } else {
        ...
        <div className="space-y-3">
          ...
          <p className="text-xl text-gray-600 font-medium">
            {isRefreshing ? (
              ...
              <>
                Your account has been credited. You now have{" "}
                <span className="font-extrabold text-lime-600">
                  {user?.listingLimit || "..."}
                </span>{" "}
                premium listing slots available!
              </>
            )}
          </p>
          {!isRefreshing && (
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-lime-100 text-lime-700 text-sm font-black animate-bounce">
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 font-medium mt-1">
                  Use your new slots to post items and reach thousands of buyers
                  instantly.
                </p>
              </div>
            </div>
            ...
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 font-medium">
                  We've sent a receipt to your email. Your listings will now
                  appear with a{" "}
                  <span className="text-lime-600 font-bold">Premium Badge</span>
                  .
                </p>
              </div>
            </div>
